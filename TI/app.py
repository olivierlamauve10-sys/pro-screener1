...
def check_conditions(df: pd.DataFrame, retracement_percent: int) -> bool:
    ...
    ema200_up_ok = (
        ...
        ema200.iloc[-25] / ema200.iloc[-55] > 1.015
    )
    ...
    ema7_down1_ok = (
        ema7.iloc[-5] < ema7.iloc[-15]
        and ema7.iloc[-15] < ema7.iloc[-25]
        and ema7.iloc[-25] < ema7.iloc[-35]
    )
    ...
    return (
        (ema50_down1_ok or ema50_down2_ok or ema7_down1_ok)
        and ema200_up_ok
        and ema7_up_ok
        and rsi_ok
        and retracement_ok
